...
Признаки это вершины графа. Легко видеть, что эксклюзивный набор признаков в этой задаче соответствует набору вершин с одинаковым цветом, и наоборот. Задача поиска оптимального объединения признаков относится к классу NP-трудных, а значит невозможно получить точное решение за полиномиальное время.
